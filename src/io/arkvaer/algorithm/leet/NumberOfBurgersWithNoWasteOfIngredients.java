...
public class NumberOfBurgersWithNoWasteOfIngredients {
    ...
    public List<Integer> numOfBurgers(int tomatoSlices, int cheeseSlices) {
        ...
        if (a < 0 || tomatoSlices < (cheeseSlices * 2) || a % 2 != 0 || tomatoSlices > (cheeseSlices * 4)) {
    ...
    public static void main(String[] args) {
        ...
        List<Integer> integers = numberOfBurgersWithNoWasteOfIngredients.numOfBurgers(2385088, 164763);
